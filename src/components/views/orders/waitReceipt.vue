<template>
  <div class="wait_receipt" ref="waitReceiptWrapper">
    <div class="container">
      <div class="listContent">
        <ul>
          <li class="goods_list" v-for="(item, index) in list" v-if="item.status == 'wait_receipt'" :key="index">
...
export default {
  ...
  mounted () {
    this.$nextTick(() => {
      initScroll(this.scroll, this.$refs.waitReceiptWrapper)
    })
    this.getOrderList()
  },
  methods: {
